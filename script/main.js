...
const animationTimeline = () => {
  ...
  const verticalImage = document.getElementsByClassName("vertical-image")[0]; // Select the vertical image element
  ...
  tl
    ...
    .to(".one", 0.7, { opacity: 0, y: 10 }, "+=4")
    .to(".two", 0.7, { opacity: 0, y: 10 }, "-=1")
    .from(".three", 0.7, { opacity: 0, y: 10 })
    .to(".three", 0.7, { opacity: 0, y: 10 }, "+=4")
    ...
    .to(".idea-5 .smiley", 0.7, { rotation: 0, x: 8 }, "+=0.4")
    ...
    .from(".lydia-dp", 0.5, { scale: 3.5, opacity: 0, x: 25, y: -25, rotationZ: -45 }, "-=3")
    ...
    .to(".last-smile", 0.5, { rotation: 0 }, "+=2")
    .from(verticalImage, 0.7, { opacity: 0, scale: 1.5, ease: Expo.easeOut }, "+=2"); // Make vertical image appear at the end
